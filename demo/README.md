# FirebaseUI for web - Auth Zw Maps
...
```bash
git clone https://github.com/armandsl/firebaseui-web.git
cd firebaseui-web
npm install
cd demo
```
...
[https://github.com/armandsl/firebaseui-web/blob/master/README.md](https://github.com/armandsl/firebaseui-web/blob/master/README.md).
